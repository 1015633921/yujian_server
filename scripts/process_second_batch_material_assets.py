...
TARGETS: dict[str, MaterialTarget] = {
    "六芒星光粉": MaterialTarget("bead", "粉水晶", "六芒星光粉", "rose_quartz"),
    "冰橘粉": MaterialTarget("bead", "粉水晶", "冰橘粉", "rose_quartz"),
    ...
    "果冻马粉": MaterialTarget("bead", "粉水晶", "马达加斯加粉晶果冻体", "rose_quartz"),
    ...
    "粉水晶": MaterialTarget("bead", "粉水晶", "粉水晶", "rose_quartz"),
    ...
    "西柚粉水晶": MaterialTarget("bead", "粉水晶", "西柚粉水晶", "rose_quartz"),
    ...
    "马粉水晶": MaterialTarget("bead", "粉水晶", "粉水晶马粉", "rose_quartz"),
