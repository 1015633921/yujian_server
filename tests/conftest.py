...
os.environ.setdefault("COMMUNITY_UGC_ENABLED", "false")
os.environ.setdefault("COMMUNITY_UGC_WRITES_ENABLED", "false")
os.environ.setdefault("COMMUNITY_MODERATION_REQUIRED", "true")
